...
- A formula that disagrees with its precursor is a question only the person
  who wrote the method can answer — which of the two is right. On the batch
  this was developed against it was the precursor: `dHCer(d18:0/12:0)`
  carried 484.465 against the 484.4724 of its own formula, 15 ppm out.
