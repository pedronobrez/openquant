...
- **"Precursor confirmed at +20.7 ppm…"**, or **"Precursor not confirmed:
  ...
  is now measured off the run — 0.068 to 3.53 counts on the nine infusions
  here — and the sentence names which of the two it refused against. What
...
| precursor 430.35 in the product-ion spectrum | 430.3197 at 84 counts, 1.49%, **−70.4 ppm** (floor 0.96) | 430.3489 at 9,415 counts, **+20.7 ppm** |
...
|---|---|---|---|
| CA-d4 CID 45 eV | 430.3197, −70.4 ppm, 84 counts | 2 of 56 | 100, its own |
| CA-d4 EAD 22 eV | 430.3489, **+20.7 ppm** | 8 of 56 | **29** at 45 eV |
| CA-d4 EAD 12 eV | 430.3488, +20.4 ppm | 3 of 56 | **6** at 45 eV |
| DCA-d4 CID 40 eV | 414.3275, −30.2 ppm, 33 counts | 3 of 41 | 99, its own |
...
- **the precursor survives the soft activations, and what is left of it under
  ...
  its precursor, at +20.4 to +30.3 ppm. The three CID runs each hold something in the window
  too — 84, 33 and 124 counts — and against a fixed floor of a hundred the
  first two were refused as *too little to measure*. Against the floor this
  acquisition actually has, 0.96 and 0.58 counts, they are 88 and 57 times
  the background and plainly there; so they are measured, and they come out
  at **−70.4 and −30.2 ppm**, which is 0.030 and 0.013 Da from the written
  mass. The height says a peak is there and the ppm says it is not the
  precursor, and the sentence on those rows now reads **"Precursor found but
  not confirmed at −70.4 ppm, past the 25 ppm that says the same ion"** —
  *confirmed* is a claim about identity and the summary line always reserved
  it for 25 ppm, so the sentence had to stop where the count does. Measuring four more precursors this way therefore added **none**
  to the four within 25 ppm: the count on the summary line is unchanged, and
  what changed is that the page now says what is in the window instead of
  refusing to look.
- **the confirmed errors are all the same sign**, +14.6 to +30.3 ppm — and
  the two the measured floor newly let through are the other one, −30.2 and
  −70.4, which is a second reason to read them as something in the window
  rather than as the precursor. One of the positives, DCA-d4 at +30.3, is
  past the 25 ppm the line counts and is on the page all the same: the count
  is a sentence, not a verdict.
